...
class Location:
    ...
    def to_xml(self):
        root_el = ET.Element("Locations")  # Elemento raiz XML

        # Adicionando os elementos XML dos estados à localização
        for state in self._states:
            root_el.append(state.to_xml())  # Adiciona diretamente a representação XML do estado ao elemento raiz
...
class State:
    ...
    def to_xml(self):
        ...
        for city in self._cities:
            state_el.append(city.to_xml())  # Adiciona diretamente a representação XML da cidade ao elemento estado
...
class City:
    ...
    def to_xml(self):
        ...
        for county in self._counties:
            city_el.append(county.to_xml())  # Adiciona diretamente a representação XML do condado ao elemento cidade
